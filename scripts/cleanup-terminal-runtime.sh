...
# Drag-and-drop / paste uploads land in ~/.os/uploads/<session>/. Prune files
# older than a week, then drop any session dirs left empty.
UPLOADS_DIR="${HOME:-/home/rahman}/.os/uploads"
