...
Target host: `Ubuntu 24.04.4 LTS`, `8 vCPU`, `31 GiB RAM`, `Node.js v22.x`
Package manager: **npm**
...
- Frontend: `npm run start -- --hostname 0.0.0.0 --port 4000`.
- Agent: `node agent/dist/index.js`.
...
- Installer: `npx rahman-cr install --vps user@<ip> --domain <tailnet>` clones the
...
- `npx rahman-cr ai claude` walks a user through setup interactively.
